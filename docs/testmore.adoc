...
* Looking at coverage reports and wonder [blue]#why you can't reach a branch#.
* Not covered code points out [red]#too much code#, as in code that is not required via TDD.
...
* The least complex code always wins, is more understandable and maintainable.
